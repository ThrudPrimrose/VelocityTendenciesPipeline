...
inline void loop_body_0_0_5(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, double* __restrict__ __CG_p_int__m_geofac_rot, int* __restrict__ __CG_p_patch__CG_verts__m_edge_blk, int* __restrict__ __CG_p_patch__CG_verts__m_edge_idx, int* __restrict__ __CG_p_patch__CG_verts__m_end_index, int* __restrict__ __CG_p_patch__CG_verts__m_start_index, double* __restrict__ __CG_p_prog__m_vn, double* __restrict__ zeta, int SOA_end_index_d_0_verts_p_patch_5, int SOA_start_index_d_0_verts_p_patch_5, int __CG_global_data__m_nproma, int __CG_p_int__m_SA_geofac_rot_d_0, int __CG_p_int__m_SA_geofac_rot_d_1, int __CG_p_int__m_SOA_geofac_rot_d_0, int __CG_p_int__m_SOA_geofac_rot_d_1, int __CG_p_int__m_SOA_geofac_rot_d_2, int __CG_p_patch__m_nblks_c, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_3_0, int i_endblk_var_119_0, int i_startblk_var_118_0) {
...
inline void reduce_12_1_19(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, double* __restrict__ _in, double* __restrict__ _out, int __CG_global_data__m_nproma) {
        ...
        }
        {
            for (auto _for_it_35 = Max(3, (nrdmax_jg - 2)); _for_it_35 < 88; _for_it_35 += 1) {
                for (auto _for_it_37 = i_startidx_var_148; _for_it_37 < (i_endidx_var_149 + 1); _for_it_37 += 1) {
                    loop_body_12_1_14(__state, &__CG_p_metrics__m_ddqz_z_half[0], &cfl_clipping[0], dtime, &levmask[0], &maxvcfl[0], &z_w_con_c[0], __CG_global_data__m_nproma, __CG_p_metrics__m_SA_ddqz_z_half_d_0, __CG_p_metrics__m_SOA_ddqz_z_half_d_0, __CG_p_metrics__m_SOA_ddqz_z_half_d_1, __CG_p_metrics__m_SOA_ddqz_z_half_d_2, __CG_p_patch__m_nblks_c, _for_it_22, _for_it_35, _for_it_37);
                }
            }
        }
        reduce_12_1_19(__state, &maxvcfl[0], &vcflmax[(_for_it_22 - 1)], __CG_global_data__m_nproma);
        {
...
inline void reduce_31_3_2(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, int* __restrict__ _in, int* __restrict__  _out, int i_endblk_var_147, int i_startblk_var_146) {
...
inline void loop_body_0_5_18(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, int* __restrict__ levmask, int* __restrict__ levelmask, int __CG_p_patch__m_nblks_c, int _for_it_46, int i_endblk_var_147, int i_startblk_var_146) {
    ...
    }
    {
        ...
        reduce_31_3_2(__state, &levmask[(((__CG_p_patch__m_nblks_c * (_for_it_46 - 1)) + i_startblk_var_146) - 1)], &_red_tmp_tmp_call_13, i_endblk_var_147, i_startblk_var_146);
...
inline void reduce_0_4_2(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, double* __restrict__ _in, double* __restrict__  _out, int i_endblk_var_147, int i_startblk_var_146) {
