...
DACE_DFI void loop_body_20_3_8(const double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, const double * __restrict__ gpu_z_w_concorr_me, double * __restrict__ gpu_z_w_concorr_mc, int A_z_w_concorr_me_d_0, int A_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_0, int OA_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_2, int __CG_global_data__m_nproma, int __CG_p_int__m_SA_e_bln_c_s_d_0, int __CG_p_int__m_SA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_0, int __CG_p_int__m_SOA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, int _for_it_25, int _for_it_26) {
    int tmp_index_445;
    int tmp_index_447;
    int tmp_index_457;
    int tmp_index_459;
...
DACE_DFI void loop_body_20_1_14(const const double&  dtime, const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, const int * __restrict__ gpu_cfl_clipping, int * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_metrics__m_SA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_1, int __CG_p_metrics__m_SOA_ddqz_z_half_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, int _for_it_35, int _for_it_37) {
    double tmp_call_8;
    int _if_cond_18;
    double vcfl;
...
DACE_DFI void reduce_40_3_2(const int * __restrict__ _in, int* __restrict__  _out, int i_endblk_var_147, int i_startblk_var_146) {
...
DACE_DFI void loop_body_0_6_21(const int * __restrict__ gpu_levmask, int * __restrict__ gpu_levelmask, int __CG_p_patch__m_nblks_c, int _for_it_46, int i_endblk_var_147, int i_startblk_var_146) {
    ...
    }
    {
        ...
        reduce_40_3_2(&gpu_levmask[(((__CG_p_patch__m_nblks_c * _for_it_46) + i_startblk_var_146) - 1)], &_red_tmp_tmp_call_13, i_endblk_var_147, i_startblk_var_146);
...
void __dace_runkernel_single_state_body_map_1_2_8_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_int__m_geofac_rot, const int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_blk, const int * __restrict__ gpu___CG_p_patch__CG_verts__m_edge_idx, const double * __restrict__ gpu___CG_p_prog__m_vn, double * __restrict__ gpu_zeta, int __CG_global_data__m_nproma, int __CG_p_int__m_SA_geofac_rot_d_0, int __CG_p_int__m_SA_geofac_rot_d_1, int __CG_p_int__m_SOA_geofac_rot_d_0, int __CG_p_int__m_SOA_geofac_rot_d_1, int __CG_p_int__m_SOA_geofac_rot_d_2, int __CG_p_patch__m_nblks_c, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_3_0, int i_endidx_var_121_0, int64_t i_startidx_var_120_0)
{
    ...
    void  *single_state_body_map_1_2_8_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu___CG_p_int__m_geofac_rot, (void *)&gpu___CG_p_patch__CG_verts__m_edge_blk, (void *)&gpu___CG_p_patch__CG_verts__m_edge_idx, (void *)&gpu___CG_p_prog__m_vn, (void *)&gpu_zeta, (void *)&__CG_global_data__m_nproma, (void *)&__CG_p_int__m_SA_geofac_rot_d_0, (void *)&__CG_p_int__m_SA_geofac_rot_d_1, (void *)&__CG_p_int__m_SOA_geofac_rot_d_0, (void *)&__CG_p_int__m_SOA_geofac_rot_d_1, (void *)&__CG_p_int__m_SOA_geofac_rot_d_2, (void *)&__CG_p_patch__m_nblks_c, (void *)&__CG_p_prog__m_SA_vn_d_0, (void *)&__CG_p_prog__m_SOA_vn_d_0, (void *)&__CG_p_prog__m_SOA_vn_d_1, (void *)&__CG_p_prog__m_SOA_vn_d_2, (void *)&_for_it_3_0, (void *)&i_endidx_var_121_0, (void *)&i_startidx_var_120_0 };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_map_1_2_8_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_121_0 - i_startidx_var_120_0) + 1), 32), 6, 1), dim3(32, 16, 1), single_state_body_map_1_2_8_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_map_1_2_8_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_121_0 - i_startidx_var_120_0) + 1), 32), 6, 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_map_11_3_19_velocity_no_nproma_if_prop_lvn_only_1_istep_1(double * __restrict__ gpu___CG_p_diag__m_vt, const double * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, const double * __restrict__ gpu___CG_p_prog__m_vn, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_1, int __CG_p_diag__m_SOA_vt_d_2, int __CG_p_int__m_SA_rbf_vec_coeff_e_d_0, int __CG_p_int__m_SA_rbf_vec_coeff_e_d_1, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_0, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_1, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_2, int __CG_p_patch__m_nblks_e, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_6, int i_endidx_var_149, int64_t i_startidx_var_148) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_map_11_3_19_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu___CG_p_diag__m_vt, const double * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, const double * __restrict__ gpu___CG_p_prog__m_vn, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_1, int __CG_p_diag__m_SOA_vt_d_2, int __CG_p_int__m_SA_rbf_vec_coeff_e_d_0, int __CG_p_int__m_SA_rbf_vec_coeff_e_d_1, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_0, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_1, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_2, int __CG_p_patch__m_nblks_e, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_6, int i_endidx_var_149, int64_t i_startidx_var_148);
void __dace_runkernel_single_state_body_map_11_3_19_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu___CG_p_diag__m_vt, const double * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, const double * __restrict__ gpu___CG_p_prog__m_vn, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_1, int __CG_p_diag__m_SOA_vt_d_2, int __CG_p_int__m_SA_rbf_vec_coeff_e_d_0, int __CG_p_int__m_SA_rbf_vec_coeff_e_d_1, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_0, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_1, int __CG_p_int__m_SOA_rbf_vec_coeff_e_d_2, int __CG_p_patch__m_nblks_e, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_6, int i_endidx_var_149, int64_t i_startidx_var_148)
{
...
DACE_EXPORTED void __dace_runkernel_single_state_body_2_map_11_4_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu___CG_p_diag__m_vn_ie, const double * __restrict__ gpu___CG_p_diag__m_vt, const double * __restrict__ gpu___CG_p_metrics__m_wgtfacq_e, const double * __restrict__ gpu___CG_p_prog__m_vn, double * __restrict__ gpu_z_kin_hor_e, double * __restrict__ gpu_z_vt_ie, double tmp_call_3, double tmp_call_4, int A_z_kin_hor_e_d_0, int A_z_kin_hor_e_d_1, int A_z_vt_ie_d_0, int A_z_vt_ie_d_1, int OA_z_kin_hor_e_d_0, int OA_z_kin_hor_e_d_1, int OA_z_kin_hor_e_d_2, int OA_z_vt_ie_d_0, int OA_z_vt_ie_d_1, int OA_z_vt_ie_d_2, int __CG_p_diag__m_SA_vn_ie_d_0, int __CG_p_diag__m_SA_vt_d_0, int __CG_p_diag__m_SOA_vn_ie_d_0, int __CG_p_diag__m_SOA_vn_ie_d_1, int __CG_p_diag__m_SOA_vn_ie_d_2, int __CG_p_diag__m_SOA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_1, int __CG_p_diag__m_SOA_vt_d_2, int __CG_p_metrics__m_SA_wgtfacq_e_d_0, int __CG_p_metrics__m_SA_wgtfacq_e_d_1, int __CG_p_metrics__m_SOA_wgtfacq_e_d_0, int __CG_p_metrics__m_SOA_wgtfacq_e_d_1, int __CG_p_metrics__m_SOA_wgtfacq_e_d_2, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_6, int i_endidx_var_149, int64_t i_startidx_var_148);
void __dace_runkernel_single_state_body_2_map_11_4_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu___CG_p_diag__m_vn_ie, const double * __restrict__ gpu___CG_p_diag__m_vt, const double * __restrict__ gpu___CG_p_metrics__m_wgtfacq_e, const double * __restrict__ gpu___CG_p_prog__m_vn, double * __restrict__ gpu_z_kin_hor_e, double * __restrict__ gpu_z_vt_ie, double tmp_call_3, double tmp_call_4, int A_z_kin_hor_e_d_0, int A_z_kin_hor_e_d_1, int A_z_vt_ie_d_0, int A_z_vt_ie_d_1, int OA_z_kin_hor_e_d_0, int OA_z_kin_hor_e_d_1, int OA_z_kin_hor_e_d_2, int OA_z_vt_ie_d_0, int OA_z_vt_ie_d_1, int OA_z_vt_ie_d_2, int __CG_p_diag__m_SA_vn_ie_d_0, int __CG_p_diag__m_SA_vt_d_0, int __CG_p_diag__m_SOA_vn_ie_d_0, int __CG_p_diag__m_SOA_vn_ie_d_1, int __CG_p_diag__m_SOA_vn_ie_d_2, int __CG_p_diag__m_SOA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_1, int __CG_p_diag__m_SOA_vt_d_2, int __CG_p_metrics__m_SA_wgtfacq_e_d_0, int __CG_p_metrics__m_SA_wgtfacq_e_d_1, int __CG_p_metrics__m_SOA_wgtfacq_e_d_0, int __CG_p_metrics__m_SOA_wgtfacq_e_d_1, int __CG_p_metrics__m_SOA_wgtfacq_e_d_2, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_6, int i_endidx_var_149, int64_t i_startidx_var_148)
{
...
void __dace_runkernel_single_state_body_map_20_3_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, double * __restrict__ gpu_z_ekinh, const double * __restrict__ gpu_z_kin_hor_e, int A_z_kin_hor_e_d_0, int A_z_kin_hor_e_d_1, int OA_z_kin_hor_e_d_0, int OA_z_kin_hor_e_d_1, int OA_z_kin_hor_e_d_2, int __CG_global_data__m_nproma, int __CG_p_int__m_SA_e_bln_c_s_d_0, int __CG_p_int__m_SA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_0, int __CG_p_int__m_SOA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148)
{
    ...
    void  *single_state_body_map_20_3_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu___CG_p_int__m_e_bln_c_s, (void *)&gpu___CG_p_patch__CG_cells__m_edge_blk, (void *)&gpu___CG_p_patch__CG_cells__m_edge_idx, (void *)&gpu_z_ekinh, (void *)&gpu_z_kin_hor_e, (void *)&A_z_kin_hor_e_d_0, (void *)&A_z_kin_hor_e_d_1, (void *)&OA_z_kin_hor_e_d_0, (void *)&OA_z_kin_hor_e_d_1, (void *)&OA_z_kin_hor_e_d_2, (void *)&__CG_global_data__m_nproma, (void *)&__CG_p_int__m_SA_e_bln_c_s_d_0, (void *)&__CG_p_int__m_SA_e_bln_c_s_d_1, (void *)&__CG_p_int__m_SOA_e_bln_c_s_d_0, (void *)&__CG_p_int__m_SOA_e_bln_c_s_d_1, (void *)&__CG_p_int__m_SOA_e_bln_c_s_d_2, (void *)&__CG_p_patch__m_nblks_c, (void *)&_for_it_22, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148 };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_map_20_3_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), 6, 1), dim3(32, 16, 1), single_state_body_map_20_3_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_map_20_3_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), 6, 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_6_map_20_3_25_velocity_no_nproma_if_prop_lvn_only_1_istep_1(const double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, double * __restrict__ gpu_z_w_concorr_mc, const double * __restrict__ gpu_z_w_concorr_me, int A_z_w_concorr_me_d_0, int A_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_0, int OA_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_2, int __CG_global_data__m_nproma, int __CG_p_int__m_SA_e_bln_c_s_d_0, int __CG_p_int__m_SA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_0, int __CG_p_int__m_SOA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_6_map_20_3_25_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, double * __restrict__ gpu_z_w_concorr_mc, const double * __restrict__ gpu_z_w_concorr_me, int A_z_w_concorr_me_d_0, int A_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_0, int OA_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_2, int __CG_global_data__m_nproma, int __CG_p_int__m_SA_e_bln_c_s_d_0, int __CG_p_int__m_SA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_0, int __CG_p_int__m_SOA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg);
void __dace_runkernel_single_state_body_6_map_20_3_25_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk, const int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, double * __restrict__ gpu_z_w_concorr_mc, const double * __restrict__ gpu_z_w_concorr_me, int A_z_w_concorr_me_d_0, int A_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_0, int OA_z_w_concorr_me_d_1, int OA_z_w_concorr_me_d_2, int __CG_global_data__m_nproma, int __CG_p_int__m_SA_e_bln_c_s_d_0, int __CG_p_int__m_SA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_0, int __CG_p_int__m_SOA_e_bln_c_s_d_1, int __CG_p_int__m_SOA_e_bln_c_s_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg)
{
    ...
    void  *single_state_body_6_map_20_3_25_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu___CG_p_int__m_e_bln_c_s, (void *)&gpu___CG_p_patch__CG_cells__m_edge_blk, (void *)&gpu___CG_p_patch__CG_cells__m_edge_idx, (void *)&gpu_z_w_concorr_mc, (void *)&gpu_z_w_concorr_me, (void *)&A_z_w_concorr_me_d_0, (void *)&A_z_w_concorr_me_d_1, (void *)&OA_z_w_concorr_me_d_0, (void *)&OA_z_w_concorr_me_d_1, (void *)&OA_z_w_concorr_me_d_2, (void *)&__CG_global_data__m_nproma, (void *)&__CG_p_int__m_SA_e_bln_c_s_d_0, (void *)&__CG_p_int__m_SA_e_bln_c_s_d_1, (void *)&__CG_p_int__m_SOA_e_bln_c_s_d_0, (void *)&__CG_p_int__m_SOA_e_bln_c_s_d_1, (void *)&__CG_p_int__m_SOA_e_bln_c_s_d_2, (void *)&__CG_p_patch__m_nblks_c, (void *)&_for_it_22, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148, (void *)&nflatlev_jg };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_6_map_20_3_25_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((91 - nflatlev_jg), 16), 1), dim3(32, 16, 1), single_state_body_6_map_20_3_25_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_6_map_20_3_25_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((91 - nflatlev_jg), 16), 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_7_map_20_3_27_velocity_no_nproma_if_prop_lvn_only_1_istep_1(double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, const double * __restrict__ gpu___CG_p_metrics__m_wgtfac_c, const double * __restrict__ gpu_z_w_concorr_mc, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_1, int __CG_p_diag__m_SOA_w_concorr_c_d_2, int __CG_p_metrics__m_SA_wgtfac_c_d_0, int __CG_p_metrics__m_SOA_wgtfac_c_d_0, int __CG_p_metrics__m_SOA_wgtfac_c_d_1, int __CG_p_metrics__m_SOA_wgtfac_c_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg) {
    {
        {
...
void __dace_runkernel_single_state_body_7_map_20_3_27_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, const double * __restrict__ gpu___CG_p_metrics__m_wgtfac_c, const double * __restrict__ gpu_z_w_concorr_mc, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_1, int __CG_p_diag__m_SOA_w_concorr_c_d_2, int __CG_p_metrics__m_SA_wgtfac_c_d_0, int __CG_p_metrics__m_SOA_wgtfac_c_d_0, int __CG_p_metrics__m_SOA_wgtfac_c_d_1, int __CG_p_metrics__m_SOA_wgtfac_c_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg)
{
    ...
    void  *single_state_body_7_map_20_3_27_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu___CG_p_diag__m_w_concorr_c, (void *)&gpu___CG_p_metrics__m_wgtfac_c, (void *)&gpu_z_w_concorr_mc, (void *)&__CG_global_data__m_nproma, (void *)&__CG_p_diag__m_SA_w_concorr_c_d_0, (void *)&__CG_p_diag__m_SOA_w_concorr_c_d_0, (void *)&__CG_p_diag__m_SOA_w_concorr_c_d_1, (void *)&__CG_p_diag__m_SOA_w_concorr_c_d_2, (void *)&__CG_p_metrics__m_SA_wgtfac_c_d_0, (void *)&__CG_p_metrics__m_SOA_wgtfac_c_d_0, (void *)&__CG_p_metrics__m_SOA_wgtfac_c_d_1, (void *)&__CG_p_metrics__m_SOA_wgtfac_c_d_2, (void *)&_for_it_22, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148, (void *)&nflatlev_jg };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_7_map_20_3_27_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((90 - nflatlev_jg), 16), 1), dim3(32, 16, 1), single_state_body_7_map_20_3_27_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_7_map_20_3_27_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((90 - nflatlev_jg), 16), 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_0_map_20_3_29_velocity_no_nproma_if_prop_lvn_only_1_istep_1(const double * __restrict__ gpu___CG_p_prog__m_w, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_prog__m_SA_w_d_0, int __CG_p_prog__m_SOA_w_d_0, int __CG_p_prog__m_SOA_w_d_1, int __CG_p_prog__m_SOA_w_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_0_map_20_3_29_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_prog__m_w, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_prog__m_SA_w_d_0, int __CG_p_prog__m_SOA_w_d_0, int __CG_p_prog__m_SOA_w_d_1, int __CG_p_prog__m_SOA_w_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148);
void __dace_runkernel_single_state_body_0_map_20_3_29_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_prog__m_w, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_prog__m_SA_w_d_0, int __CG_p_prog__m_SOA_w_d_0, int __CG_p_prog__m_SOA_w_d_1, int __CG_p_prog__m_SOA_w_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148)
{
    ...
    void  *single_state_body_0_map_20_3_29_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu___CG_p_prog__m_w, (void *)&gpu_z_w_con_c, (void *)&__CG_global_data__m_nproma, (void *)&__CG_p_prog__m_SA_w_d_0, (void *)&__CG_p_prog__m_SOA_w_d_0, (void *)&__CG_p_prog__m_SOA_w_d_1, (void *)&__CG_p_prog__m_SOA_w_d_2, (void *)&_for_it_22, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148 };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_0_map_20_3_29_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), 6, 1), dim3(32, 16, 1), single_state_body_0_map_20_3_29_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_0_map_20_3_29_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), 6, 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_1_map_20_4_14_velocity_no_nproma_if_prop_lvn_only_1_istep_1(double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int i_endidx_var_149, int64_t i_startidx_var_148) {
    {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_1_map_20_4_14_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int i_endidx_var_149, int64_t i_startidx_var_148);
void __dace_runkernel_single_state_body_1_map_20_4_14_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int i_endidx_var_149, int64_t i_startidx_var_148)
{
    ...
    void  *single_state_body_1_map_20_4_14_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu_z_w_con_c, (void *)&__CG_global_data__m_nproma, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148 };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_1_map_20_4_14_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 512), 1, 1), dim3(512, 1, 1), single_state_body_1_map_20_4_14_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_1_map_20_4_14_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 512), 1, 1, 512, 1, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_2_map_20_4_17_velocity_no_nproma_if_prop_lvn_only_1_istep_1(const double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_1, int __CG_p_diag__m_SOA_w_concorr_c_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_2_map_20_4_17_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_1, int __CG_p_diag__m_SOA_w_concorr_c_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg);
void __dace_runkernel_single_state_body_2_map_20_4_17_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_0, int __CG_p_diag__m_SOA_w_concorr_c_d_1, int __CG_p_diag__m_SOA_w_concorr_c_d_2, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148, int nflatlev_jg)
{
    ...
    void  *single_state_body_2_map_20_4_17_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu___CG_p_diag__m_w_concorr_c, (void *)&gpu_z_w_con_c, (void *)&__CG_global_data__m_nproma, (void *)&__CG_p_diag__m_SA_w_concorr_c_d_0, (void *)&__CG_p_diag__m_SOA_w_concorr_c_d_0, (void *)&__CG_p_diag__m_SOA_w_concorr_c_d_1, (void *)&__CG_p_diag__m_SOA_w_concorr_c_d_2, (void *)&_for_it_22, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148, (void *)&nflatlev_jg };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_2_map_20_4_17_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((90 - nflatlev_jg), 16), 1), dim3(32, 16, 1), single_state_body_2_map_20_4_17_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_2_map_20_4_17_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((90 - nflatlev_jg), 16), 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_3_map_20_4_16_velocity_no_nproma_if_prop_lvn_only_1_istep_1(int * __restrict__ gpu_levmask, int __CG_p_patch__m_nblks_c, int _for_it_22, int nrdmax_jg) {
    {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_3_map_20_4_16_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, int * __restrict__ gpu_levmask, int __CG_p_patch__m_nblks_c, int _for_it_22, int nrdmax_jg);
void __dace_runkernel_single_state_body_3_map_20_4_16_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, int * __restrict__ gpu_levmask, int __CG_p_patch__m_nblks_c, int _for_it_22, int nrdmax_jg)
{
    ...
    void  *single_state_body_3_map_20_4_16_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu_levmask, (void *)&__CG_p_patch__m_nblks_c, (void *)&_for_it_22, (void *)&nrdmax_jg };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_3_map_20_4_16_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 512), 1, 1), dim3(512, 1, 1), single_state_body_3_map_20_4_16_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_3_map_20_4_16_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil((88 - Max(3, (nrdmax_jg - 2))), 512), 1, 1, 512, 1, 1);
}
__global__ void  __launch_bounds__(512) init_maxvcfl_20_1_20_velocity_no_nproma_if_prop_lvn_only_1_istep_1(double * __restrict__ gpu_maxvcfl, int __CG_global_data__m_nproma) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_init_maxvcfl_20_1_20_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu_maxvcfl, int __CG_global_data__m_nproma);
void __dace_runkernel_init_maxvcfl_20_1_20_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu_maxvcfl, int __CG_global_data__m_nproma)
{
    ...
    void  *init_maxvcfl_20_1_20_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu_maxvcfl, (void *)&__CG_global_data__m_nproma };
    gpuError_t __err = cudaLaunchKernel((void*)init_maxvcfl_20_1_20_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(__CG_global_data__m_nproma, 32), 6, 1), dim3(32, 16, 1), init_maxvcfl_20_1_20_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "init_maxvcfl_20_1_20_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(__CG_global_data__m_nproma, 32), 6, 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_4_map_20_1_24_velocity_no_nproma_if_prop_lvn_only_1_istep_1(const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, const int * __restrict__ gpu_cfl_clipping, int * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_metrics__m_SA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_1, int __CG_p_metrics__m_SOA_ddqz_z_half_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, const double dtime, int i_endidx_var_149, int64_t i_startidx_var_148, int nrdmax_jg) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_4_map_20_1_24_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, const int * __restrict__ gpu_cfl_clipping, int * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_metrics__m_SA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_1, int __CG_p_metrics__m_SOA_ddqz_z_half_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, const double dtime, int i_endidx_var_149, int64_t i_startidx_var_148, int nrdmax_jg);
void __dace_runkernel_single_state_body_4_map_20_1_24_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, const int * __restrict__ gpu_cfl_clipping, int * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl, double * __restrict__ gpu_z_w_con_c, int __CG_global_data__m_nproma, int __CG_p_metrics__m_SA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_0, int __CG_p_metrics__m_SOA_ddqz_z_half_d_1, int __CG_p_metrics__m_SOA_ddqz_z_half_d_2, int __CG_p_patch__m_nblks_c, int _for_it_22, const double dtime, int i_endidx_var_149, int64_t i_startidx_var_148, int nrdmax_jg)
{
    ...
    void  *single_state_body_4_map_20_1_24_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu___CG_p_metrics__m_ddqz_z_half, (void *)&gpu_cfl_clipping, (void *)&gpu_levmask, (void *)&gpu_maxvcfl, (void *)&gpu_z_w_con_c, (void *)&__CG_global_data__m_nproma, (void *)&__CG_p_metrics__m_SA_ddqz_z_half_d_0, (void *)&__CG_p_metrics__m_SOA_ddqz_z_half_d_0, (void *)&__CG_p_metrics__m_SOA_ddqz_z_half_d_1, (void *)&__CG_p_metrics__m_SOA_ddqz_z_half_d_2, (void *)&__CG_p_patch__m_nblks_c, (void *)&_for_it_22, (void *)&dtime, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148, (void *)&nrdmax_jg };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_4_map_20_1_24_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((88 - Max(3, (nrdmax_jg - 2))), 16), 1), dim3(32, 16, 1), single_state_body_4_map_20_1_24_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_4_map_20_1_24_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), int_ceil((88 - Max(3, (nrdmax_jg - 2))), 16), 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) reduce_values_29_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1(const double * __restrict__ _in, double * __restrict__ _out, int __CG_global_data__m_nproma) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_reduce_values_29_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ _in, double * __restrict__ _out, int __CG_global_data__m_nproma);
void __dace_runkernel_reduce_values_29_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ _in, double * __restrict__ _out, int __CG_global_data__m_nproma)
{
    ...
    void  *reduce_values_29_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&_in, (void *)&_out, (void *)&__CG_global_data__m_nproma };
    gpuError_t __err = cudaLaunchKernel((void*)reduce_values_29_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(__CG_global_data__m_nproma, 32), 6, 1), dim3(32, 16, 1), reduce_values_29_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "reduce_values_29_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(__CG_global_data__m_nproma, 32), 6, 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_5_map_20_1_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1(const double * __restrict__ gpu_z_w_con_c, double * __restrict__ gpu_z_w_con_c_full, int __CG_global_data__m_nproma, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148) {
    {
        {
...
void __dace_runkernel_single_state_body_5_map_20_1_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ gpu_z_w_con_c, double * __restrict__ gpu_z_w_con_c_full, int __CG_global_data__m_nproma, int _for_it_22, int i_endidx_var_149, int64_t i_startidx_var_148)
{
    ...
    void  *single_state_body_5_map_20_1_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu_z_w_con_c, (void *)&gpu_z_w_con_c_full, (void *)&__CG_global_data__m_nproma, (void *)&_for_it_22, (void *)&i_endidx_var_149, (void *)&i_startidx_var_148 };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_5_map_20_1_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), 6, 1), dim3(32, 16, 1), single_state_body_5_map_20_1_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_5_map_20_1_22_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endidx_var_149 - i_startidx_var_148) + 1), 32), 6, 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_0_map_0_6_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1(int * __restrict__ gpu_levelmask, const int * __restrict__ gpu_levmask, int __CG_p_patch__m_nblks_c, int i_endblk_var_147, int i_startblk_var_146, int nrdmax_jg) {
    {
        int _for_it_46 = (((blockIdx.x * 32 + threadIdx.x) + Max(3, (nrdmax_jg - 2))) - 1);
        if (_for_it_46 >= (Max(3, (nrdmax_jg - 2)) - 1) && _for_it_46 < 87) {
            loop_body_0_6_21(&gpu_levmask[0], &gpu_levelmask[0], __CG_p_patch__m_nblks_c, _for_it_46, i_endblk_var_147, i_startblk_var_146);
        }
    }
}


DACE_EXPORTED void __dace_runkernel_single_state_body_0_map_0_6_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, int * __restrict__ gpu_levelmask, const int * __restrict__ gpu_levmask, int __CG_p_patch__m_nblks_c, int i_endblk_var_147, int i_startblk_var_146, int nrdmax_jg);
void __dace_runkernel_single_state_body_0_map_0_6_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, int * __restrict__ gpu_levelmask, const int * __restrict__ gpu_levmask, int __CG_p_patch__m_nblks_c, int i_endblk_var_147, int i_startblk_var_146, int nrdmax_jg)
{
    ...
    void  *single_state_body_0_map_0_6_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&gpu_levelmask, (void *)&gpu_levmask, (void *)&__CG_p_patch__m_nblks_c, (void *)&i_endblk_var_147, (void *)&i_startblk_var_146, (void *)&nrdmax_jg };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_0_map_0_6_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 32), int_ceil(((i_endblk_var_147 - i_startblk_var_146) + 1), 16), 1), dim3(32, 16, 1), single_state_body_0_map_0_6_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_0_map_0_6_23_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 32), int_ceil(((i_endblk_var_147 - i_startblk_var_146) + 1), 16), 1, 32, 16, 1);
}
__global__ void  __launch_bounds__(512) single_state_body_0_map_42_3_34_velocity_no_nproma_if_prop_lvn_only_1_istep_1(double * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc, const double * __restrict__ gpu___CG_p_diag__m_vn_ie, const double * __restrict__ gpu___CG_p_diag__m_vt, const double * __restrict__ gpu___CG_p_int__m_c_lin_e, const double * __restrict__ gpu___CG_p_metrics__m_coeff_gradekin, const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, const double * __restrict__ gpu___CG_p_patch__CG_edges__m_f_e, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, const double * __restrict__ gpu_z_ekinh, const double * __restrict__ gpu_z_kin_hor_e, const double * __restrict__ gpu_z_w_con_c_full, const double * __restrict__ gpu_zeta, int A_z_kin_hor_e_d_0, int A_z_kin_hor_e_d_1, int OA_z_kin_hor_e_d_0, int OA_z_kin_hor_e_d_1, int OA_z_kin_hor_e_d_2, int SA_cell_blk_d_1_edges_p_patch_4, int SA_cell_idx_d_1_edges_p_patch_4, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_ddt_vn_apc_pc_d_0, int __CG_p_diag__m_SA_ddt_vn_apc_pc_d_2, int __CG_p_diag__m_SA_vn_ie_d_0, int __CG_p_diag__m_SA_vt_d_0, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_0, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_1, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_2, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_3, int __CG_p_diag__m_SOA_vn_ie_d_0, int __CG_p_diag__m_SOA_vn_ie_d_1, int __CG_p_diag__m_SOA_vn_ie_d_2, int __CG_p_diag__m_SOA_vt_d_0, int __CG_p_diag__m_SOA_vt_d_1, int __CG_p_diag__m_SOA_vt_d_2, int __CG_p_int__m_SA_c_lin_e_d_0, int __CG_p_int__m_SA_c_lin_e_d_1, int __CG_p_int__m_SOA_c_lin_e_d_0, int __CG_p_int__m_SOA_c_lin_e_d_1, int __CG_p_int__m_SOA_c_lin_e_d_2, int __CG_p_metrics__m_SA_coeff_gradekin_d_0, int __CG_p_metrics__m_SA_coeff_gradekin_d_1, int __CG_p_metrics__m_SA_ddqz_z_full_e_d_0, int __CG_p_metrics__m_SOA_coeff_gradekin_d_0, int __CG_p_metrics__m_SOA_coeff_gradekin_d_1, int __CG_p_metrics__m_SOA_coeff_gradekin_d_2, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_0, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_1, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_2, int __CG_p_patch__m_nblks_e, int _for_it_47, int i_endidx_var_149, int64_t i_startidx_var_148, const int ntnd) {
    {
        {
...
DACE_EXPORTED void __dace_runkernel_single_state_body_map_42_3_36_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc, const double * __restrict__ gpu___CG_p_int__m_c_lin_e, const double * __restrict__ gpu___CG_p_int__m_geofac_grdiv, const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e, const double * __restrict__ gpu___CG_p_patch__CG_edges__m_area_edge, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, const double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, const double * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, const double * __restrict__ gpu___CG_p_prog__m_vn, const int * __restrict__ gpu_levelmask, const double * __restrict__ gpu_z_w_con_c_full, const double * __restrict__ gpu_zeta, int SA_cell_blk_d_1_edges_p_patch_4, int SA_cell_idx_d_1_edges_p_patch_4, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_ddt_vn_apc_pc_d_0, int __CG_p_diag__m_SA_ddt_vn_apc_pc_d_2, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_0, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_1, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_2, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_3, int __CG_p_int__m_SA_c_lin_e_d_0, int __CG_p_int__m_SA_c_lin_e_d_1, int __CG_p_int__m_SA_geofac_grdiv_d_0, int __CG_p_int__m_SA_geofac_grdiv_d_1, int __CG_p_int__m_SOA_c_lin_e_d_0, int __CG_p_int__m_SOA_c_lin_e_d_1, int __CG_p_int__m_SOA_c_lin_e_d_2, int __CG_p_int__m_SOA_geofac_grdiv_d_0, int __CG_p_int__m_SOA_geofac_grdiv_d_1, int __CG_p_int__m_SOA_geofac_grdiv_d_2, int __CG_p_metrics__m_SA_ddqz_z_full_e_d_0, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_0, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_1, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_2, int __CG_p_patch__m_nblks_e, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_47, const double cfl_w_limit, const double dtime, int i_endidx_var_149, int64_t i_startidx_var_148, int nrdmax_jg, const int ntnd, const double scalfac_exdiff);
void __dace_runkernel_single_state_body_map_42_3_36_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double * __restrict__ gpu___CG_p_diag__m_ddt_vn_apc_pc, const double * __restrict__ gpu___CG_p_int__m_c_lin_e, const double * __restrict__ gpu___CG_p_int__m_geofac_grdiv, const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_full_e, const double * __restrict__ gpu___CG_p_patch__CG_edges__m_area_edge, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, const double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, const double * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_blk, const int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, const double * __restrict__ gpu___CG_p_prog__m_vn, const int * __restrict__ gpu_levelmask, const double * __restrict__ gpu_z_w_con_c_full, const double * __restrict__ gpu_zeta, int SA_cell_blk_d_1_edges_p_patch_4, int SA_cell_idx_d_1_edges_p_patch_4, int __CG_global_data__m_nproma, int __CG_p_diag__m_SA_ddt_vn_apc_pc_d_0, int __CG_p_diag__m_SA_ddt_vn_apc_pc_d_2, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_0, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_1, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_2, int __CG_p_diag__m_SOA_ddt_vn_apc_pc_d_3, int __CG_p_int__m_SA_c_lin_e_d_0, int __CG_p_int__m_SA_c_lin_e_d_1, int __CG_p_int__m_SA_geofac_grdiv_d_0, int __CG_p_int__m_SA_geofac_grdiv_d_1, int __CG_p_int__m_SOA_c_lin_e_d_0, int __CG_p_int__m_SOA_c_lin_e_d_1, int __CG_p_int__m_SOA_c_lin_e_d_2, int __CG_p_int__m_SOA_geofac_grdiv_d_0, int __CG_p_int__m_SOA_geofac_grdiv_d_1, int __CG_p_int__m_SOA_geofac_grdiv_d_2, int __CG_p_metrics__m_SA_ddqz_z_full_e_d_0, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_0, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_1, int __CG_p_metrics__m_SOA_ddqz_z_full_e_d_2, int __CG_p_patch__m_nblks_e, int __CG_p_prog__m_SA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_0, int __CG_p_prog__m_SOA_vn_d_1, int __CG_p_prog__m_SOA_vn_d_2, int _for_it_47, const double cfl_w_limit, const double dtime, int i_endidx_var_149, int64_t i_startidx_var_148, int nrdmax_jg, const int ntnd, const double scalfac_exdiff)
{
...
DACE_EXPORTED void __dace_runkernel_reduce_values_19_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ _in, double * __restrict__ _out, int i_endblk_var_147, int i_startblk_var_146);
void __dace_runkernel_reduce_values_19_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, const double * __restrict__ _in, double * __restrict__ _out, int i_endblk_var_147, int i_startblk_var_146)
{
    ...
    void  *reduce_values_19_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args[] = { (void *)&_in, (void *)&_out, (void *)&i_endblk_var_147, (void *)&i_startblk_var_146 };
    gpuError_t __err = cudaLaunchKernel((void*)reduce_values_19_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1, dim3(int_ceil(((i_endblk_var_147 - i_startblk_var_146) + 1), 512), 1, 1), dim3(512, 1, 1), reduce_values_19_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "reduce_values_19_0_5_velocity_no_nproma_if_prop_lvn_only_1_istep_1", int_ceil(((i_endblk_var_147 - i_startblk_var_146) + 1), 512), 1, 1, 512, 1, 1);
}
